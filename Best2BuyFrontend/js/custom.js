...
function masanory() {
    if ($('#isotop-gallery-wrapper').length) {
        const $grid = $('#isotop-gallery-wrapper').isotope({
            // options
...
function ServicesPackagesSlider() {
    const carouselOne = $('#services-packages-slider');
...
//     const carouselOne = $('#Case-Studies-slider');
//     if (carouselOne.length) {
//         carouselOne.owlCarousel({
//             items: 2,
//             margin: 30,
...
function CaseStudiesSliderVtwo() {
    const carouselOne = $('#client-carousel');
    if (carouselOne.length) {
        carouselOne.owlCarousel({
            items: 3,
            margin: 30,
...
function ourSEOexpertsSlider() {
    const carouselOne = $('#our-SEO-experts-slider');
    if (carouselOne.length) {
        carouselOne.owlCarousel({
            items: 4,
            margin: 30,
...
function OurTrustedClientLogo() {
    const carouselOne = $('#Our-Trusted-Client-Logo');
    if (carouselOne.length) {
        carouselOne.owlCarousel({
            items: 4,
            margin: 30,
...
function productSlider() {
    const carouselOne = $('#related-product-slider-carousel');
    if (carouselOne.length) {
        carouselOne.owlCarousel({
            loop: true,
            margin: 30,
