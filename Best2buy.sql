...
INSERT INTO `customers` VALUES (5, 'Gail', '925 Woodbine St', 'Pitssburgh', 'PA', '15201', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '4125556666', 'gail@tmpbox.net');
INSERT INTO `customers` VALUES (6, 'Garfield', '5442 Wakefield St', 'Philadelphia', 'PA', '19144', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '2151111111', 'garfield@tmpbox.net');
INSERT INTO `customers` VALUES (7, 'Campbell	\r\nCampbell	\r\nCampbell', '5604 Baynton St', 'Philadelphia', 'PA', '19144', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '2152222222', 'campbell@tmpbox.net');
INSERT INTO `customers` VALUES (8, 'Camilla', '5390 Magnolia St', 'Philadelphia', 'PA', '19144', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '2153333333', 'camilla@tmpbox.net');
INSERT INTO `customers` VALUES (9, 'Lacey', '5750 Virginian Rd', 'Philadelphia', 'PA', '19141', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '2154444444', 'lacey@tmpbox.net');
INSERT INTO `customers` VALUES (10, 'Madeline', '6047 N 13th St', 'Philadelphia', 'PA', '19141', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '2155555555', 'madeline@tmpbox.net');
INSERT INTO `customers` VALUES (11, 'Madonna', '219 E 30th St', 'NYC', 'NY', '10016', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '2121111111', 'madonna@tmpbox.net');
INSERT INTO `customers` VALUES (12, 'Mae', '16 E 65th St', 'NYC', 'NY', '10065', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '2122222222', 'mae@tmpbox.net');
INSERT INTO `customers` VALUES (13, 'Oliver', '216 E 83rd St', 'NYC', 'NY', '10028', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '2123333333', 'oliver@tmpbox.net');
INSERT INTO `customers` VALUES (14, 'Rachel', '429 E 84th St', 'NYC', 'NY', '10028', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '2124444444', 'rachel@tmpbox.net');
INSERT INTO `customers` VALUES (15, 'Ramsey', '34 Prince St', 'Boston', 'MA', '02113', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '6171111111', 'ramsey@tmpbox.net');
INSERT INTO `customers` VALUES (16, 'Randall', '101 Beverly St', 'Boston', 'MA', '02114', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '6172222222', 'randall@tmpbox.net');
INSERT INTO `customers` VALUES (17, 'Catherina', '8 Pinckney St', 'Boston', 'MA', '02108', 'Business', '81dc9bdb52d04dc20036dbd8313ed055', '6173333333', 'catherina@tmpbox.net');
INSERT INTO `customers` VALUES (18, 'Cecil', '37 Halstead St', 'Newark', 'NJ', '07106', 'Home', '81dc9bdb52d04dc20036dbd8313ed055', '8621111111', 'cecil@tmpbox.net');
...
CREATE TABLE `homecustomer`  (
  ...
  `MarriageStatus` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `inventory`  (
  ...
  `NumberOfProduct` int NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `inventory` VALUES (1, 1, 301);
INSERT INTO `inventory` VALUES (1, 2, 5);
INSERT INTO `inventory` VALUES (1, 3, 12);
...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES (1, 'Playstation DualSense Wireless Controller', 471, 69.00, 'Video Games', 'https://m.media-amazon.com/images/I/61O9tWR6WDS._SL1475_.jpg');
...
INSERT INTO `products` VALUES (3, 'Alienware m15 R4 Gaming Laptop', 32, 1899.99, 'Electronics', 'https://m.media-amazon.com/images/I/71Jp27bTQoL._AC_SL1500_.jpg');
...
CREATE TABLE `transactions`  (
  ...
  `SalespersonName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ProductID` int NOT NULL,
...
-- ----------------------------
DROP TRIGGER IF EXISTS `addCustomer`;
delimiter ;;
CREATE TRIGGER `addCustomer` AFTER INSERT ON `customers` FOR EACH ROW begin
	set @kind= (select Kind from customers where CustomerID=new.CustomerID);
	if @kind='Home' then
			insert into homecustomer(CustomerID,`Name`) values(new.CustomerID,new.`Name`);
		else if @kind='Business' then
			insert into businesscustomer(CustomerID,`Name`) values(new.CustomerID,new.`Name`);
			end if;
		end if;
end
;;
...
delimiter ;;
CREATE TRIGGER `deleteCustomer` BEFORE DELETE ON `customers` FOR EACH ROW begin
	set @kind= (select Kind from customers where CustomerID=old.CustomerID);
	if @kind='Home' then
		delete from homecustomer where customerID=old.CustomerID;
		else if @kind='Business' then
			delete from businesscustomer where customerID=old.CustomerID;
			end if;
		end if;
end
;;
...
delimiter ;;
CREATE TRIGGER `Sum_Update` AFTER UPDATE ON `inventory` FOR EACH ROW begin
	update products set products.InventoryAmount=products.InventoryAmount+new.NumberOfProduct-old.NumberOfProduct where products.ProductID=new.ProductID;
end
;;
delimiter ;
...
delimiter ;;
CREATE TRIGGER `Sum` AFTER INSERT ON `inventory` FOR EACH ROW begin
	update products set products.InventoryAmount=products.InventoryAmount+new.NumberOfProduct where products.ProductID=new.ProductID;
end
;;
delimiter ;
...
delimiter ;;
CREATE TRIGGER `Sum_Delete` BEFORE DELETE ON `inventory` FOR EACH ROW begin
	update products set products.InventoryAmount=products.InventoryAmount-old.NumberOfProduct where products.ProductID=old.ProductID;
end
;;
delimiter ;
